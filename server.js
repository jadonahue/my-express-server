...
app.get("/",function(request, response){ // Usually people will use "req", "res" for request and response here. req, res is best practice.
    response.send("<h1>Hello World!</h1>"); // You could also send plain text "hello" instead of html, etc.
});
